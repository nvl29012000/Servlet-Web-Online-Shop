...
<a class="btn btn-primary" href="<c:url value='/admin-newcategory?type=edit&ID=${model.getID()}'/> ">
    Sửa
</a>
<a class="btn btn-primary" href="<c:url value='/admin-newcategory?type=list'/> ">
    Trở về
</a>
<br />
<hr/>
