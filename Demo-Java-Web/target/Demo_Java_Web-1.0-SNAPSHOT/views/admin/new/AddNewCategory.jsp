...
<br/>
<div>
    <a href="<c:url value='/admin-newcategory?type=list' />" class="btn btn-primary"><span
    ...
    <div class="form-horizontal">
        ...
        <div class="form-group">
            <div class="col-md-10">
                ...
                <input list="newcategory-parentid" id="parentID" name="parentID" class="form-control" value=""/>
        ...
        <div class="form-group">
            <div class="col-md-offset-2 col-md-10">
                <a href="#" class="btn btn-primary" id="AddNewCategory">Thêm mới</a>
            </div>
        </div>
    </div>
    <br/>
