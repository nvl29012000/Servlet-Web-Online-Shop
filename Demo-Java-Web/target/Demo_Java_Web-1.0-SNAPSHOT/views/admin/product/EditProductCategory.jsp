    ...
    <div class="form-horizontal">
        ...
        <div class="form-group">
            <div class="col-md-10">
                ...
                <input list="productcategory-parentid" id="parentID" name="parentID" class="form-control" value="${model.getParentID()}"/>
...
<script>
    ...
    $('#EditProductCategory').click(function (e){
        e.preventDefault();
        let data = {};
...
<%--<script src="<c:url value='/Assets/admin/libraries/ckeditor/ckeditor.js'/>"></script>--%>
<%--<script src="<c:url value='/Assets/admin/libraries/ckfinder/ckfinder.js'/>"></script>--%>
<%--<script>--%>
<%--	let editor = CKEDITOR.replace('metaDescription');--%>
<%--	CKFinder.setupCKEditor(editor,'Assets/admin/libraries/ckfinder/');--%>
<%--	editor.setData($('#metaDescription').val());--%>
<%--	$('#EditProductCategory').click(function (e){--%>
<%--        e.preventDefault();--%>
<%--        let finder = new CKFinder();--%>
<%--        finder.selectActionFunction = function (url) {--%>
