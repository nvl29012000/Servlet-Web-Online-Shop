...
<head>
    ...
    <link href="<c:url value='/Assets/web/css/custom.css' />" rel="stylesheet" />
    <link href="<c:url value='/Assets/web/css/responsive.css'/> " />
...
<%@include file="/common/web/footer.jsp"%>
    ...
    <script src="<c:url value='/Assets/web/js/cart.js' />"></script>
    <script src="<c:url value='/Assets/web/js/bxslider.min.js' />"></script>
    <script src="<c:url value='/Assets/web/js/script.slider.js' />"></script>
    <script src="<c:url value='/Assets/web/js/luckmoshyJqueryPagnation.js'/> "></script>
</body>
</html>
