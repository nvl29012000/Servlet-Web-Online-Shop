            ...
            <li class="nav-item">
                ...
                <div class="multi-level collapse " role="list" id="submenu-app" aria-expanded="false">
                    <ul class="flex-column nav">
                        ...
                        <li class="nav-item ">
                            <a class="nav-link" href="<c:url value='/admin-successbill' />">
                                                <span>
            ...
            <li class="nav-item">
                ...
                <div class="multi-level collapse " role="list" id="submenu-pages" aria-expanded="false">
                    <ul class="flex-column nav">
                        ...
                        <li class="nav-item ">
                            <a class="nav-link" href="<c:url value='/admin-product?type=list&page=1&items=3' />">
                                                <span>
                                                    <span class="sidebar-icon"><span
                        ...
                        <li class="nav-item ">
                            <a class="nav-link" href="<c:url value='/admin-newcategory?type=list' />">
                                                <span>
                                                    <span class="sidebar-icon"><span
                        ...
                        <li class="nav-item ">
                            <a class="nav-link" href="<c:url value='/admin-new?type=list&page=1&items=3' />" >
                                                <span>
                                                    <span class="sidebar-icon"><span
            ...
            <li class="nav-item">
                ...
                <div class="multi-level collapse " role="list" id="submenu-components" aria-expanded="false">
                    <ul class="flex-column nav">
                        ...
                        <li class="nav-item ">
                            <a class="nav-link" href="<c:url value='/admin-contact' />">
                                                <span>
