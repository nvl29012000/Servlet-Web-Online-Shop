                ...
                <div class="user-menu">
                    <ul>
                        ...
                        <c:if test="${empty USER}">
                            <li><a href="#myModal" class="form-btn" data-toggle="modal"><i class="fa fa-sign-in"></i>Login</a></li>
                            <li><a href="#myModel" class="form-btn" data-toggle="modal"><i class="fa fa-plus-circle"></i>Sign up</a></li>
                        </c:if>
                    </ul>
                </div>
            </div>
        ...
        <div class="modal-dialog modal-login">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control" name="userName" id="register-userName" placeholder="Tài khoản" required="required"/>
                    </div>
                    <div class="form-group">
                        <input type="password" class="form-control" name="password" id="register-password" placeholder="Mật khẩu" required="required"/>
                    </div>
                    <div class="form-group">
                        <input type="password" class="form-control" name="password" id="re-password" placeholder="Nhập lại mật khẩu" required="required"/>
                    </div>
                    <div class="form-group">
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <div class="shopping-item">
                    <a href="#">Giỏ hàng <span class="cart-amunt"></span> <i class="fa fa-shopping-cart"></i> <span class="product-count">5</span></a>
                </div>
            </div>
        </div>
    </div>
